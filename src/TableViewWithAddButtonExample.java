...
public class TableViewWithAddButtonExample extends Application {
  ...
  @Override public void start(final Stage stage) {
    ...
    stage.getIcons().add(new Image("http://icons.iconarchive.com/icons/google/noto-emoji-food-drink/1024/32345-lemon-icon.png"));  // icon license: Linkware (Backlink to http://www.icons-land.com required)
